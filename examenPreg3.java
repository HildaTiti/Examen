...
//clase para poner datos del cliente
class Cliente
{
	int ci;
	String nombre;
	...
	public String BusClien(int ci){
		String clieCom="No existe";
...
class Ventas
{
	...
	public void ListarCantidadProductosVendidos(){
		...
		try{
			arcw = new File("reporte de ventas");
			if(!arcw.exists()) 	arcw.createNewFile();
			fw = new FileWriter(arcw);								
